...
import { checkCard } from "@/actions/bingo";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-slate-900 font-sans p-4">
      <div className="text-center w-full max-w-md">
        <h1 className="text-4xl font-black mb-4">
          Bem-vindo ao evento da{" "}
          <span className="text-emerald-600 uppercase">{subdomain}</span>
        </h1>
        ...
        <div className="p-8 bg-white shadow-xl rounded-3xl border border-slate-100">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-50 text-red-600 rounded-xl flex items-center justify-center gap-2 text-sm font-medium">
              <AlertCircle size={16} />
              {error}
            </div>
          )}
