...
import { useRouter } from "next/navigation"; // Certifique-se de usar o roteador correto do Next 15
...
export default function LoginPage() {
  ...
  const handleCredentialsLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // O Middleware cuidará de redirecionar o Operador para /live e o Admin para /dashboard
        ...
        <div className="flex flex-col space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleCredentialsLogin}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors disabled:opacity-50"
            >
